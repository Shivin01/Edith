...
func (s *Slack) GetUserDetails(userId string, ref msg.Ref) *slack.User {
...
// NewPostMessage is the "slow" reply via POST request, needed for Attachment or MsgRef
func (s *Slack) NewPostMessage(ref msg.Ref, channelId, text string, options ...slack.MsgOption) string {
