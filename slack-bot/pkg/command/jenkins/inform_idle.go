...
func (c *idleWatcherCommand) GetMatcher() matcher2.Matcher {
	return matcher2.NewTextMatcher("wait until jenkins is idle", c.run)
}

func (c *idleWatcherCommand) run(match matcher2.Result, message msg.Message) {
